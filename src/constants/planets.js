export const PLANETS = {
	...
	venus: {
		...
		structure: {
			img: './images/planet-venus-internal.svg',
			name: 'VENUS',
			description:
	...
	earth: {
		...
		structure: {
			img: './images/planet-earth-internal.svg',
			name: 'EARTH',
			description:
	...
	mars: {
		...
		structure: {
			img: './images/planet-mars-internal.svg',
			name: 'MARS',
			description:
	...
	jupiter: {
		...
		structure: {
			img: './images/planet-jupiter-internal.svg',
			name: 'JUPITER',
			description:
	...
	saturn: {
		...
		structure: {
			img: './images/planet-saturn-internal.svg',
			name: 'SATURN',
			description:
	...
	uranus: {
		...
		structure: {
			img: './images/planet-uranus-internal.svg',
			name: 'URANUS',
			description:
	...
	neptune: {
		...
		structure: {
			img: './images/planet-neptune-internal.svg',
			name: 'NEPTUNE',
			description:
